        ...
        <SelectTrigger className="min-w-[100px] sm:min-w-[140px] h-6 sm:h-8 text-xs">
          <SelectValue placeholder="Select a model">
            <div className="flex items-center gap-1 sm:gap-1.5">
              ...
              {(selectedModelInfo?.type === 'image' || selectedModelInfo?.type === 'video') && (
                // Crown icon reused from ImageModelPopup
                    ...
                    <div className="flex items-start gap-1.5 w-full">
                      ...
                      <div className="flex flex-col gap-0 min-w-0 flex-1">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-[6px] bg-red-100 text-red-700 px-1 py-0.5 rounded-full font-medium flex-shrink-0">
                            VIDEO
                          </span>
                        </div>
                        <span className="text-[8px] text-muted-foreground leading-tight line-clamp-1">
